...
var AllCommands = BotCommands{
	PrivateUserCommands: []td.BotCommand{
		...
		cmd("removefromplaylist", "➖ Remove a track from a playlist"),
		cmd("playlistinfo", "ℹ️ Show a playlist's tracks"),
		cmd("myplaylists", "📚 List your playlists"),
	},
	...
	GroupAdminCommands: []td.BotCommand{
		...
		cmd("askip", "⏭️ Skip to next autoplay track"),
		cmd("caskip", "⏭️ Skip to next autoplay in linked channel"),
		...
		cmd("vclogger", "🎙️ Toggle voice chat alerts"),
		cmd("vcstatus", "📊 View voice chat logger status"),
